<li class="dropdown menu__item">
    <a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown"
        role="button" aria-haspopup="true" aria-expanded="false">Men's <span
            class="caret"></span></a>
                    ...
                    @php
                        foreach ($categories as $key => $category) {
                            if ($category->type == 'male' && $key < 8) {
                                echo '<li><a href="category/'.$category->type.'/'.$category->id.'">' . $category->name . '</a></li>';
                            }
                        }
                    @endphp
...
<li class="dropdown menu__item">
    <a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown"
        role="button" aria-haspopup="true" aria-expanded="false">Women's<span
            class="caret"></span></a>
    <ul class="dropdown-menu multi-column columns-3">
        <div class="agile_inner_drop_nav_info">
            <div class="col-sm-6 multi-gd-img1 multi-gd-text ">
                <a href="{{ url('category/female/0') }}"><img
