 ...
 *   https://datatables.net/download/#bs5/dt-2.1.3/af-2.7.0/b-3.1.1/date-1.5.3
 *
 * Included libraries:
 *   DataTables 2.1.3, AutoFill 2.7.0, Buttons 3.1.1, DateTime 1.5.3
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs5/dt-2.1.3/af-2.7.0/b-3.1.1/date-1.5.3",
